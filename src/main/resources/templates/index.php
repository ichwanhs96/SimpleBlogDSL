      ...
      <ul class="art-list-body">
       ...
       <li class="art-list-item">
        <div class="art-list-item-title-and-time">
         <h2 class="art-list-title"><a href="post.php?id=<?php echo $f0 ?>">
           <?php echo $f1; ?></a></h2>
         ...
         <?php echo $f2; ?></p> <p id="edit_delete">
         <a style="margin-right:20px" id="editlink" href="edit_post.php?id=<?php echo $f0 ?>">Edit</a>
         <a id="deletelink" href="javascript:DeletePost(<?php echo $f0 ?>)">Hapus</a> </p> </li>
       <?php
